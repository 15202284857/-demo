...
/********以下方法是通过AVFoundation实现拍照**********/
/**
 *  拍照
 */
- (IBAction)avfoundation:(id)sender {
    
    avFoundationViewController *av = [[avFoundationViewController alloc]init];
    UINavigationController *nv = [[UINavigationController alloc]initWithRootViewController:av];
...
- (IBAction)recordVideo:(id)sender {
    ...
    vedioViewController *av = [[vedioViewController alloc]init];
    UINavigationController *nv = [[UINavigationController alloc]initWithRootViewController:av];
    [self presentViewController:nv animated:YES completion:nil];
}
